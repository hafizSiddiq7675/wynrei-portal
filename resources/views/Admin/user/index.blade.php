            ...
            <form action="">
                <div class="mt-4 mb-4">
                    <div class=" input-group-md">
                        <input type="text" required class="form-control" placeholder="Enter User Type" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg">
                      </div>
                    <div class=" input-group-md mt-3">
                        <input type="text" required class="form-control" placeholder="Enter Properties" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg">
                      </div>
                      <div class="input-group-md mt-3">
                        <input type="text" required class="form-control" placeholder="Enter Bids" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg">
                      </div>
                      <div class="input-group-md mt-3">
                        <input type="text" required class="form-control" placeholder="Enter Markets" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg">
                      </div>
                </div>
               </form>
          </div>
