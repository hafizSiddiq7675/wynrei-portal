               ...
               <h4 class="mt-4 text-center">
                ...
                <div class="mt-5">
                    ...
                    <div class=" input-group-md mb-3">
                        <input type="email" readonly name="email" readonly class="form-control" placeholder="Enter Your email" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" value="{{ $email ?? old('email') }}">
                        @error('email')
